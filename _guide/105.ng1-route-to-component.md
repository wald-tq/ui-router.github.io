...
we highly recommend that the Angular 1.5 component model is adopted instead.  

In this guide, we'll cover:

- Angular 1.5 component concepts
- how to route to Angular 1.5 components 
...
An Angular 1.5 `component` is a reusable piece of a web page, which encapsulates both structure (markup) and behavior.
...
<iframe class="plunker" style="height: 450px;"
    src="http://embed.plnkr.co/nnK1Vc/?show=script.js,preview&deferRun"></iframe>

# Migrate to components

To begin routing to components, the view is converted from a template and controller to an Angular 1.5 component.
...
An Angular 1.5 `.component()` also has a `bindings:` object which maps component inputs to controller properties.
...
<iframe class="plunker" style="height: 450px;"
    src="http://embed.plnkr.co/RDPZZ4/?show=script.js,preview&deferRun"
></iframe>
...
contains all the information about about the transition which activated a routed component.
...
Angular 1.5 components offer a simpler mental model for composing a UI out of nested components.
...
<iframe class="plunker" style="height: 450px;"
    src="https://embed.plnkr.co/6Vk1dN/?show=script.js,preview&deferRun"></iframe>
...
<iframe class="plunker" style="height: 450px;"
    src="http://embed.plnkr.co/FhoJBc/?show=script.js,preview&deferRun"></iframe>
